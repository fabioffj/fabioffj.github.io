    ...
    return {
      ...
      upgrades: {
        0: {
          'type': 'stat',
          'names': 'Mais Força',
          'descriptions' : 'Aumenta sua força base. Dá mais dano.',
          'cost' : 25,
          'level' : 1,
          'increment' : 1,
        ...
        1: {
          'type': 'stat',
          'names': 'Mais Inteligência',
          'descriptions' : 'Aumenta sua inteligência e ganha mais xp.',
          'cost' : 25,
          'level' : 1,
          'increment' : 1,
          'costIncreasePerLevel' : 20,
        ...
        2: {
          'type': 'stat',
          'names': 'Mais Velocidade',
          'descriptions' : 'Aumenta sua velocidade de ataque!',
          'cost' : 25,
          'level' : 1,
          'increment' : 1,
          'costIncreasePerLevel' : 20,
            ...
            if(_this.enemiesDefeated > _this.enemiesPerStage - 1) {
              ...
              setTimeout(function() {
                ...
                if(_this.enemiesDefeated == 10 && _this.stage == 10) {
                  _this.enemy = new Enemy(3000, 'Rei Eduardo');
                  _this.boss = true;
                } else {
